/*
UploadiFivePro By Snake
Based On UploadiFive 1.2.2
Just For Study
*/
/*
UploadiFive 1.2.2
    ...
    var methods = {
        ...
        settings : function(name, value, resetObjects) {
            ...
            this.each(function() {
                // Create a reference to the jQuery DOM object
                var $this        = $(this),
                    h5uploadifive = $this.data('uploadifive'),
                    settings     = h5uploadifive.settings;
                ...
                if (args.length === 1) {
                    ...
                    switch (name) {
                        case 'uploadScript':
                            settings.uploadScript=value.toString();
                            break;
                        case 'formData':
                            if (!resetObjects) {
                        ...
                        case 'method':
                            ...
                            break;
                        case 'fileObjName':
                            settings.fileObjName = value.toString();
                            break;
                        case 'fileType':
                            settings.fileType = value.toString();
                            break;
                            break;
                        case 'fileSizeLimit':
                            ...
                            break;
                        case 'uploadLimit':
                            settings.uploadLimit = value;
                            break;
                        case 'queueSizeLimit':
                            settings.queueSizeLimit = value;
                            break;
                        case 'buttonImage':
                            h5uploadifive.button.css('background-image', value);
                            break;
                        case 'buttonText':
